        ...
        <div className="text-center">
          ...
          <Fade>
            <div className="user-info mb-4">
              ...
              <h1 className="mb-3">
                <span className="d-flex justify-content-center text-center header-intro">
                  <span className="text-intro">{info.items[0].userIntro}</span>
                  <Typewriter
                    options={{
                      strings: [info.items[0].userName, info.items[0].userRole],
                      autoStart: true,
                      delay: 100,
                      loop: true,
                    }}
            ...
            <div className="d-flex justify-content-center">
              <a href={info.items[0].linkedIn} className="header-btn list-btn">
